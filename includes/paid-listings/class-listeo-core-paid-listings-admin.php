...
class Listeo_Core_Paid_Listings_Admin {
	...
	public function admin_menu() {
		add_submenu_page( 'listeo_settings', __( 'Listing Packages', 'listeo_core' ), __( 'Listing Packages', 'listeo_core' ), 'manage_options', 'listeo_core_paid_listings_packages' , array( $this, 'packages_page' ) );
	}
