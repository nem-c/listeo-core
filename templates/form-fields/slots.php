...
<div class="availability-slots" data-clock-type="<?php echo esc_attr( $clock_format ); ?>hr">
	...
	if ( isset( $data->field['value'] ) ) {
		if ( true === is_string( $data->field['value'] ) ) {
	...
	<?php foreach ( $days as $id => $dayname ) {
        ...
        <div class="day-slots">
            ...
            <div class="slots-container">
				...
				<?php if ( isset( $field ) && is_array( $field[ $int ] ) ) {
					foreach ( $field[ $int ] as $slot ) { // slots loop
						$slot = explode( '|', $slot ); ?>
                        <div class="single-slot ui-sortable-handle">
                            ...
                            <div class="single-slot-right">
                                ...
                                <div class="plusminus horiz">
                                    ...
                                    <input type="number" name="slot-qty" id="slot-qty"
                                           value="<?php echo esc_html( $slot[1] ); ?>" min="1" max="99">
                                    <button></button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="add-slot">
                <div class="add-slot-inputs">
                    ...
                    <input type="text" class="time-slot-start slot-time-input" placeholder="--:--" maxlength="5"
                           size="5"/>
                    ...
                    <input type="text" class="time-slot-end slot-time-input" placeholder="--:--" maxlength="5"
                           size="5"/>
					<?php if ( $clock_format == '12' ) { ?>
