   ...
   //      	}
		...
		if(isset($args['_listing_type']) && $args['_listing_type'] == 'rental' && isset($args['date_start']) && !empty($args['date_start'])) {
		  ...
		  //       $date_end =  str_replace("/", "-", 	$args['date_end']);
		        ...
		        $date_start = DateTime::createFromFormat('!'.listeo_date_time_wp_format_php(), $args['date_start'])->getTimestamp();
		        $date_end = DateTime::createFromFormat('!'.listeo_date_time_wp_format_php(), $args['date_end'])->getTimestamp();
					
		        $date_start = esc_sql ( date( "Y-m-d H:i:s", $date_start  ) );
	            $date_end = esc_sql ( date( "Y-m-d H:i:s", $date_end ) );
