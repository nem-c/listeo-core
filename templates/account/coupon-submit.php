		...
		<div id="usage_restriction_coupon_data" class="panel woocommerce_options_panel" style="display: block;">
				...
				<div class="col-md-6">
					<p class="form-field minimum_amount_field ">
						...
						<input type="text" class="short wc_input_price" style="" name="minimum_amount" id="minimum_amount" value="<?php if(isset($coupon_id)) echo esc_html(get_post_meta($coupon_id,'minimum_amount',true)); ?>" placeholder="<?php esc_html_e('No minimum','listeo_core'); ?>"> 
					</p>
				</div>
				<div class="col-md-6">
					<p class="form-field maximum_amount_field ">
						<label for="maximum_amount"><?php esc_html_e('Maximum spend','listeo_core'); ?></label>
						<input type="text" class="short wc_input_price" style="" name="maximum_amount" id="maximum_amount" value="<?php if(isset($coupon_id)) echo esc_html(get_post_meta($coupon_id,'maximum_amount',true)); ?>" placeholder="<?php esc_html_e('No maximum','listeo_core'); ?>"> 
					</p>
				</div>
					<div class="col-md-6">
				<p class="form-field">
