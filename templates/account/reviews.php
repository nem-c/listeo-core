...
<div class="col-lg-12 col-md-12">
	...
	<div class="dashboard-list-box reviews-visitior-box margin-top-0">
		...
		<div id="small-dialog-edit" class="zoom-anim-dialog mfp-hide">
			...
			<form action="" id="send-comment-edit-reply">
				<div class="message-reply margin-top-0">
					...
					<textarea id="comment_reply" required name="comment_reply" cols="40" rows="3"></textarea>
					<button id="send-comment-edit-reply" class="button"><i class="fa fa-circle-o-notch fa-spin"></i><?php esc_html_e('Reply','listeo_core') ?></button>
				</div>
			</form>
	...
	<div id="visitor-reviews-pagination" class="pagination-container margin-top-30 margin-bottom-0">
		...
		<div id="small-dialog-edit" class="zoom-anim-dialog mfp-hide">
			...
			<form action="" id="send-comment-edit-review">
				<div class="message-reply margin-top-0">
					...
					<textarea id="comment_reply" required name="comment_reply" cols="40" rows="3"></textarea>
					<button id="send-comment-edit-review" class="button"><i class="fa fa-circle-o-notch fa-spin"></i><?php esc_html_e('Reply','listeo_core') ?></button>
				</div>
			</form>
						...
						<ul>
							<li>
								...
								<div class="comment-content"><div class="arrow-comment"></div>
									...
									?>
									<a href="#small-dialog-edit" class="edit-reply edit-review rate-review  popup-with-zoom-anim" 
