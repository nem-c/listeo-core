	...
	public function init_fields() {
		...
		if(empty($packages_disabled_modules)) {
			$packages_disabled_modules = array();
			 ...
			 // { 
			 // [0]=> string(14) "option_booking" 
			 // [1]=> string(14) "option_reviews" 
			 // [2]=> string(14) "option_gallery" 
			 // [3]=> string(19) "option_social_links" 
			 // [4]=> string(20) "option_opening_hours" 
			 // [5]=> string(12) "option_video" 
			 // [6]=> string(14) "option_coupons" }
			//var_dump(array_search('booking', $this->fields))
			$package = false;
