						...
						switch ( $listing->post_status ) {
							case 'publish' :
									...
									if(get_option('listeo_new_listing_requires_purchase')){
										$actions['renew'] = array( 'label' => __( 'Change Package', 'listeo_core' ), 'icon' => 'sl sl-icon-wrench', 'nonce' => false );	
									}
							...
							case 'expired' :
								...
								$actions['renew'] = array( 'label' => __( 'Renew', 'listeo_core' ), 'icon' => 'refresh', 'nonce' => false );
