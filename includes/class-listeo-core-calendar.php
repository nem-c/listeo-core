	...
	function getWeekDayName() {
		...
		foreach ( $this_WeekDayName as $dayname ) {
			switch ($dayname) {
				...
				case 'SUN':	$translated_day = __('SUN','listeo_core'); break;
				case 'MON':	$translated_day = __('MON','listeo_core'); break;
				case 'TUE':	$translated_day = __('TUE','listeo_core'); break;
				case 'WED':	$translated_day = __('WED','listeo_core'); break;
				case 'THU':	$translated_day = __('THU','listeo_core'); break;
				case 'FRI':	$translated_day = __('FRI','listeo_core'); break;
				case 'SAT':	$translated_day = __('SAT','listeo_core'); break;
